...
<head>
    ...
    <!-- FONTS FILE -->
    <link href="<?php echo BASE_URL; ?>public/assets/fonts/css/all.min.css" rel="stylesheet" type="text/css">

    <!-- Nunito FONT FAMILY FILE -->
    <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">

    <!-- CSS FILES -->
    <link href="<?php echo BASE_URL; ?>public/css/admin/sb-admin-2.min.css" rel="stylesheet">
    <link href="<?php echo BASE_URL; ?>public/css/admin/main.css" rel="stylesheet">

    <!-- Barber Icons -->
    <link rel="stylesheet" type="text/css" href="<?php echo BASE_URL; ?>public/assets/fonts/css/all.min.css">
    <link rel="stylesheet" type="text/css" href="<?php echo BASE_URL; ?>public/css/admin/barber-icons.css">
