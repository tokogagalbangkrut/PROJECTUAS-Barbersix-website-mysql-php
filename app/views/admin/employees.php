                        ...
                        <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php
                                                ...
                                                if (isset($_POST['add_new_employee']))
                                                {
                                                    ...
                                                    {
                                                        echo '<div class="invalid-feedback" style="display: block;">First name is required.</div>';
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php
                                                if (isset($_POST['add_new_employee']))
                                                {
                                                    ...
                                                    {
                                                        echo '<div class="invalid-feedback" style="display: block;">Last name is required.</div>';
                                                        $flag_add_employee_form = 1;
                                                    }
                                                }
                                            ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php
                                                if (isset($_POST['add_new_employee']))
                                                {
                                                    ...
                                                    {
                                                        echo '<div class="invalid-feedback" style="display: block;">Phone number is required.</div>';
                                                        $flag_add_employee_form = 1;
                                                    }
                                                }
                                            ?>
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <?php
                                                if (isset($_POST['add_new_employee']))
                                                {
                                                    ...
                                                    {
                                                        echo '<div class="invalid-feedback" style="display: block;">Email is required.</div>';
                                                        $flag_add_employee_form = 1;
                                                    }
                                                }
                                            ?>
                            ...
                            <?php
                                ...
                                if (isset($_POST['add_new_employee']) && $_SERVER['REQUEST_METHOD'] == 'POST' && $flag_add_employee_form == 0)
                                {
                                    ...
                                    $employee_lname = test_input($_POST['employee_lname']);
                                    ...
                                    {
                                        echo "<div class='alert alert-danger' style='margin:10px 0px;'>Error occurred: " . htmlspecialchars($e->getMessage()) . "</div>";
                                    }
                                }
                            ?>
                        </div>
                                    ...
                                    <form method="POST" action="employees.php?do=Edit&employee_id=<?php echo $employee_id; ?>">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="employee_fname">First Name</label>
                                                    <input type="text" class="form-control" value="<?php echo htmlspecialchars($employee['first_name']); ?>" placeholder="First Name" name="employee_fname">
                                                    <?php
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="employee_lname">Last Name</label>
                                                    <input type="text" class="form-control" value="<?php echo htmlspecialchars($employee['last_name']); ?>" placeholder="Last Name" name="employee_lname">
                                                    <?php
                                                        if (isset($_POST['edit_employee_sbmt']))
                                                        {
                                                            if (empty(test_input($_POST['employee_lname'])))
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="employee_phone">Phone Number</label>
                                                    <input type="text" class="form-control" value="<?php echo htmlspecialchars($employee['phone_number']); ?>" placeholder="Phone number" name="employee_phone">
                                                    <?php
                                                        if (isset($_POST['edit_employee_sbmt']))
                                                        {
                                                            if (empty(test_input($_POST['employee_phone'])))
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group"> 
                                                    <label for="employee_email">E-mail</label>
                                                    <input type="text" class="form-control" value="<?php echo htmlspecialchars($employee['email']); ?>" placeholder="E-mail" name="employee_email">
                                                    <?php
                                                        if (isset($_POST['edit_employee_sbmt']))
                                                        {
                                                            if (empty(test_input($_POST['employee_email'])))
                                        ...
                                        <!-- SUBMIT BUTTON -->
                                        <button type="submit" name="edit_employee_sbmt" class="btn btn-primary">Edit employee</button>
                                    </form>
