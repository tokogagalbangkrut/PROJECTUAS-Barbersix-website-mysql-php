...
// Include menggunakan absolute path internal PHP
include __DIR__ . '/../models/connect.php';
include __DIR__ . '/../../config/Includes/functions/functions.php';
include __DIR__ . '/../../config/Includes/templates/header.php';
include __DIR__ . '/../../config/Includes/templates/navbar.php';
?>

<!-- Appointment Page Stylesheet (Menggunakan BASE_URL) -->
<link rel="stylesheet" href="<?php echo BASE_URL; ?>config/Design/css/appointment-page-style.css">
...
$stmt_appointment->execute(array(
    Date("Y-m-d H:i"),
    is_array($client_id) ? $client_id[0] : $client_id,
    $selected_employee,
    $start_time,
    $end_time
));
                                    ...
                                    echo "<div class = 'item_select_part'>";
                                        ...
                                        echo "<div class = 'service_price_field'>";
                                            echo "<span style = 'font-weight: bold;'>";
                                                echo "Rp " . number_format($row['service_price'], 0, ',', '.');
                                            echo "</span>";
                                        echo "</div>";
                                    ?>
            ...
            <div class="select_date_time_div tab_reservation" id="calendar_tab">
                ...
                <div class="calendar_tab" style="overflow-x: auto;overflow-y: visible;" id="calendar_tab_in">
                    <div id="calendar_loading">
                        <img src="<?php echo BASE_URL; ?>config/Design/images/ajax_loader_gif.gif" style="display: block;margin-left: auto;margin-right: auto;">
                    </div>
                </div>
